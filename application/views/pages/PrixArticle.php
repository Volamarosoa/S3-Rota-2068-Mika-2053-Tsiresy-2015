      ...
      <div class="container">
        ...
        <?php for($i=0; $i<count($article); $i++) { ?>
          <div class="col-lg-4 col-md-6 portfolio-item <?php echo $article[$i]['nomcategorie']; ?>">
            ...
            <span><a href="<?php echo site_url(); ?>Article/rechercheArticle/<?php echo $article[$i]['article']['id']; ?>/10">-10%+</a> Ou <a href="<?php echo site_url(); ?>Article/rechercheArticle/<?php echo $article[$i]['article']['id']; ?>/20">-20%+</a></span>
          </div>
        <?php } ?>
        </div>

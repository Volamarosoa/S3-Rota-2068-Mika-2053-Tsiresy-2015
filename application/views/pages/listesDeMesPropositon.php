  ...
  <main id="main">
    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container proposition">
        <h3>Votre listes de propositions pour les autres utilisateurs: </h3>
        <br>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>mail</strong>: <?php echo $proposition[$i]['objet2']['utilisateur']['mail']; ?></li>
              </ul>
            </div>
          ...
          <div class="bouton" style="display: flex; margin: 12px 990px;">
                <a href="<?php echo site_url(); ?>Propositions/annulerEchange/<?php echo $proposition[$i]['proposition']['id']; ?>"><button class="btn btn-primary" type="submit" style="background-color: red; bs-btn-border-color: red;bs-btn-hover-border-color: red;">
                    Annuler
                </button></a>
          </div>
